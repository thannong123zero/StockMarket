...
export class ChartComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    ...
    const valueAxis = chart.yAxes.push(am5xy.ValueAxis.new(this.root, {
      renderer: valueAxisRenderer,
      height: am5.percent(70)
    }));
    valueAxis.axisHeader.children.push(am5.Label.new(this.root, {
      text: "Value",
      fontWeight: "bold",
      paddingBottom: 5,
      paddingTop: 5
    ...
    const volumeAxisRenderer = am5xy.AxisRendererY.new(this.root, {
      inside: true
    });
    ...
    const volumeAxis = chart.yAxes.push(am5xy.ValueAxis.new(this.root, {
      renderer: volumeAxisRenderer,
      height: am5.percent(30),
      layer: 5
    }));
    volumeAxis.axisHeader.set("paddingTop", 10);
    volumeAxis.axisHeader.children.push(am5.Label.new(this.root, {
      text: "Volume",
      fontWeight: "bold",
      paddingTop: 5,
      paddingBottom: 5
    ...
    const dateAxis = chart.xAxes.push(am5xy.GaplessDateAxis.new(this.root, {
      groupData: true,
      baseInterval: {
        timeUnit: "day",
        count: 1
    ...
    dateAxis.set("tooltip", am5.Tooltip.new(this.root, {}));


    // Add series
    // https://www.amcharts.com/docs/v5/charts/xy-chart/series/
    const valueSeries1 = chart.series.push(am5xy.LineSeries.new(this.root, {
      name: "XTD",
      valueYField: "price1",
    ...
    const valueTooltip = valueSeries1.set("tooltip", am5.Tooltip.new(this.root, {
    ...
    valueTooltip.get("background")!.set("fill", this.root.interfaceColors.get("background"));

    const firstColor = chart.get("colors")!.getIndex(0);
    const volumeSeries = chart.series.push(am5xy.ColumnSeries.new(this.root, {
      name: "XTD",
      fill: firstColor,
      stroke: firstColor,
    ...
    chart.leftAxesContainer.set("layout", this.root.verticalLayout);
    ...
    const scrollbar = chart.set("scrollbarX", am5xy.XYChartScrollbar.new(this.root, {
